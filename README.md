...
Prebuild binaries can be picked up from [our zooserver download site] [zoobin]. See the [Starting][https://github.com/ECF/ZooServer/blob/master/README.md#starting] section on how to run.
